...
static uint8_t  DFR_USBD_CDC_Init(USBD_HandleTypeDef *pdev,
                              uint8_t cfgidx);

static uint8_t  DFR_USBD_CDC_DeInit(USBD_HandleTypeDef *pdev,
                                uint8_t cfgidx);

static uint8_t  DFR_USBD_CDC_Setup(USBD_HandleTypeDef *pdev,
                               USBD_SetupReqTypedef *req);

static uint8_t  DFR_USBD_CDC_DataIn(USBD_HandleTypeDef *pdev,
                                uint8_t epnum);

static uint8_t  DFR_USBD_CDC_DataOut(USBD_HandleTypeDef *pdev,
                                 uint8_t epnum);
...
__ALIGN_BEGIN static uint8_t DFR_USBD_CDC_DeviceQualifierDesc[USB_LEN_DEV_QUALIFIER_DESC] __ALIGN_END =
{
...
USBD_ClassTypeDef  DFR_USBD_CDC =
{
  DFR_USBD_CDC_Init,
  DFR_USBD_CDC_DeInit,
  DFR_USBD_CDC_Setup,
  NULL,                 /* EP0_TxSent, */
  DFR_USBD_CDC_EP0_RxReady,
  DFR_USBD_CDC_DataIn,
  DFR_USBD_CDC_DataOut,
  NULL,
  NULL,
  NULL,
  DFR_USBD_CDC_GetHSCfgDesc,
  DFR_USBD_CDC_GetFSCfgDesc,
  DFR_USBD_CDC_GetOtherSpeedCfgDesc,
  DFR_USBD_CDC_GetDeviceQualifierDescriptor,
};

/* USB CDC device Configuration Descriptor */
__ALIGN_BEGIN uint8_t DFR_USBD_CDC_CfgHSDesc[DFR_USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
{
  /*Configuration Descriptor*/
  0x09,   /* bLength: Configuration Descriptor size */
  USB_DESC_TYPE_CONFIGURATION,      /* bDescriptorType: Configuration */
  DFR_USB_CDC_CONFIG_DESC_SIZ,                /* wTotalLength:no of returned bytes */
  0x00,
...
/* USB CDC device Configuration Descriptor */
__ALIGN_BEGIN uint8_t DFR_USBD_CDC_CfgFSDesc[DFR_USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
{
  /*Configuration Descriptor*/
  0x09,   /* bLength: Configuration Descriptor size */
  USB_DESC_TYPE_CONFIGURATION,      /* bDescriptorType: Configuration */
...
__ALIGN_BEGIN uint8_t DFR_USBD_CDC_OtherSpeedCfgDesc[DFR_USB_CDC_CONFIG_DESC_SIZ] __ALIGN_END =
{
  0x09,   /* bLength: Configuation Descriptor size */
  USB_DESC_TYPE_OTHER_SPEED_CONFIGURATION,
  DFR_USB_CDC_CONFIG_DESC_SIZ,
  0x00,
